...
Create a challenging level that requires at least 3 different types of gates and has a non-trivial solution.
...
3. Include at least 3 different types of gates
...
export const level{level_number} = {{
    ...
    description: 'Create a circuit that implements a complex logic function using multiple gates.',
    difficulty: 4,
    availableGates: [
        GATE_TYPES.INPUT,
        GATE_TYPES.OUTPUT,
...
def validate_level_config(js_code):
    ...
    if gates_found < 3:
        print("Level must use at least 3 different types of gates")
        return False
...
def main():
    ...
    level_number = 8  # Next level number
